module.exports = {
  ...
  async execute (message, args) {
    ...
    if (args[0]) {
      ...
      try {
        await banStore.save({ key: banStore.key(['bans', robloxData.data.Id]), data: { roblox_id: robloxData.data.Id, banned: false, hidden_from_leaderboards: true, radio_disabled: false, radio_disabled_until: null } })
